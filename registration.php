...
<tr>
 <td>
 <label for="usname">Account Number</label>
 </td>
 <td>
 ...
 <tr>
 <td>
 <label for="initial_balance">Account Number</label>
 </td>
 <td>
...
values('$Username','$bal','$Password','$Email','$Gender','$Mobile_no','$Address')";
